...
__global__ void GPU_HoughTranConstant(unsigned char* pic, int w, int h, int* acc, float rMax, float rScale)
{
...
int main(int argc, char** argv)
{
    ...
    GPU_HoughTranConstant<<< blockNum, 256 >>> (d_in, w, h, d_hough, rMax, rScale);
